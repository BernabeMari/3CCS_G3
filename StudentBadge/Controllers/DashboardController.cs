...
public class DashboardController : Controller
{
    ...
    public DashboardController(IConfiguration configuration, ILogger<DashboardController> logger, IWebHostEnvironment hostingEnvironment, EmailService emailService)
    {
    ...
    public async Task<IActionResult> UpdateStudentScore(string studentId, int score, string achievements = null, string comments = null)
    {
        try
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                string badgeColor = "green";
                if (displayScore >= 95) badgeColor = "platinum";
                else if (displayScore >= 85) badgeColor = "gold";
                else if (displayScore >= 75) badgeColor = "silver";
                else if (displayScore >= 65) badgeColor = "bronze";
                else if (displayScore >= 50) badgeColor = "rising-star";
                else badgeColor = "warning";
