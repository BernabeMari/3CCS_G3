                ...
                using (var connection = new SqlConnection(_connectionString))
                {
                    ...
                    foreach (var student in students)
                    {
                        ...
                        if (!string.IsNullOrEmpty(userId))
                        {
                            ...
                            {
                                cmd.Parameters.AddWithValue("@YearLevel", student.GradeLevel);
                                var result = await cmd.ExecuteScalarAsync();
                                
                                if (result != null && result != DBNull.Value)
                                {
                                    student.TotalAvailableChallenges = Convert.ToInt32(result);
                                }
                            }
                            ...
                            if (calculatedScore >= 95) badgeColor = "platinum";
                            else if (calculatedScore >= 85) badgeColor = "gold";
                            else if (calculatedScore >= 75) badgeColor = "silver";
                            else if (calculatedScore >= 65) badgeColor = "bronze";
                            else if (calculatedScore >= 50) badgeColor = "rising-star";
